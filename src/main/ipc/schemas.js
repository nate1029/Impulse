...
const schemas = {
  ...
  aiSetModel: z.object({ modelId: requiredString, manual: z.boolean().optional() }),
  aiPinModel: z.object({ modelId: z.string().optional().nullable() }),
  aiSetAutoUpgrade: z.object({ enabled: z.boolean() }),
